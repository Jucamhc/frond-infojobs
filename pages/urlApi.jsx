...
const urlApi = () => {
  ...
  const [inputGetProvincia, setInputGetProvincia] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&provinceIds=');
  const [inputGetCiudad, setInputGetCiudad] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&cityIds=');
  const [inputGetTeletrabajo, setInputGetTeletrabajo] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&teleworkingIds=');
  const [inputGetCategoriaTrabajo, setInputGetCategoriaTrabajo] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&categoryIds=');
  const [inputGetEducationIds, setInputGetEducationIds] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&educationIds=');
  const [inputGetWorkdayIds, setInputGetWorkdayIds] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&workdayIds=');
  const [inputGetcontract, setInputGetcontract] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&contractTypeIds=');
  const [inputGetcountryIds, setInputGetcountryIds] = useState('https://api-infojobs.hop.sh/api-offers/search?page=1&countryIds=');
  ...
  const seProvince = async () => {
    ...
    let inputSetProvincia = `https://api-infojobs.hop.sh/api-offers/search?page=1&provinceIds=${provin}`;
  ...
  const seCity = async () => {
    ...
    let inputSetCity = `https://api-infojobs.hop.sh/api-offers/search?page=1&cityIds=${city}`;
  ...
  const seTeleworking = async () => {
    ...
    let inputSetTeletrabajo = `https://api-infojobs.hop.sh/api-offers/search?page=1&teleworkingIds=${teletrabajo}`;
  ...
  const seCategory = async () => {
    ...
    let inputSetCategoriaTrabajo = `https://api-infojobs.hop.sh/api-offers/search?page=1&categoryIds=${category}`;
  ...
  const seEducation = async () => {
    ...
    let inputSetEducation = `https://api-infojobs.hop.sh/api-offers/search?page=1&educationIds=${provin}`;
  ...
  const seWorkday = async () => {
    ...
    let inputSetWorkdayIds = `https://api-infojobs.hop.sh/api-offers/search?page=1&workdayIds=${provin}`;
  ...
  const seContractType = async () => {
    ...
    let inputSetContractType = `https://api-infojobs.hop.sh/api-offers/search?page=1&contractTypeIds=${provin}`;
  ...
  const seCountry = async () => {
    ...
    let inputSetCountry = `https://api-infojobs.hop.sh/api-offers/search?page=1&countryIds=${provin}`;
